...
EDIT_IP_TITLE = "Edit name of IP {}. Leave blank to erase name."
DELETE_IP_SUCCESS = "IP {} deleted"

SAVE_PROFILE = "Save profile as... (Leave blank to overwrite current profile: {})"
SAVE_PROFILE_SUCCESS_NEW = "Profile {} saved successfully"
SAVE_PROFILE_SUCCESS_OVERWRITE = "Overwrite profile {} successfully"
SAVE_PROFILE_EXIT = "Exiting... Save profile? y/n (Current profile: {})"
PROFILE_NOT_EXISTS = "Profile {} does not exist. Exiting..."
FILE_UNABLE_ACCESS = "Unable to access file {}"
FILE_PATH_NOT_PRESENT = "File path not present"
